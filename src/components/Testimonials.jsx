        ...
        <div style={{ position: 'relative', width: '100%', zIndex: 2 }}>
          ...
          <div
            ...
            style={{
              ...
              paddingLeft: '10vw', paddingRight: '10vw', paddingBottom: '24px',
          ...
          >
            {testimonials.map((t, idx) => (
              <div key={idx} style={{ flexShrink: 0, width: 'clamp(320px, 25vw, 420px)', scrollSnapAlign: 'center' }}>
...
function TestimonialCard({ t, index }) {
  ...
  return (
    <motion.div
      ...
      transition={{ duration: 0.7, delay: Math.min(index * 0.04, 0.3), ease: [0.16, 1, 0.3, 1] }}
    >
      <div
        ref={cardRef}
